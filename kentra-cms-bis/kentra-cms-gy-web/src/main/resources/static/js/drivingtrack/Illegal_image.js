layui.use(['form', 'element'], function () {
    ...
    $.ajax({
  	  ...
  	  success: function(result) { 
  		var details = "";
//  			details += "<h4 class='layui-timeline-title' style='margin-left: 60px;margin-top: 10px'>"+active.dateFormate(result[0].passTime,"yyyy-MM-dd hh:mm:ss")+ "<span style='margin-left:70px;'>"+result[0].stationName+"</span>"+"</h4>"
